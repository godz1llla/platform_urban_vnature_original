...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Садувакас%' AND role = 'instructor' LIMIT 1),
    '№201',
    'monday',
    1,
    '09:00:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Мусалаева%' AND role = 'instructor' LIMIT 1),
    '№204',
    'friday',
    2,
    '10:30:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Жұмаканов%' AND role = 'instructor' LIMIT 1),
    '№302',
    'friday',
    3,
    '12:20:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Төребаева%' AND role = 'instructor' LIMIT 1),
    '№209',
    'friday',
    4,
    '13:50:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Амангельдиев%' AND role = 'instructor' LIMIT 1),
    '№326',
    'friday',
    2,
    '10:30:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Жарманов%' AND role = 'instructor' LIMIT 1),
    '№301',
    'friday',
    4,
    '13:50:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Раймбаева%' AND role = 'instructor' LIMIT 1),
    '№205',
    'wednesday',
    1,
    '09:00:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Хамитова%' AND role = 'instructor' LIMIT 1),
    '№301',
    'friday',
    3,
    '12:20:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Байдильдина%' AND role = 'instructor' LIMIT 1),
    '№209',
    'friday',
    4,
    '13:50:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Махин%' AND role = 'instructor' LIMIT 1),
    '№310',
    'friday',
    2,
    '10:30:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Орынбасар%' AND role = 'instructor' LIMIT 1),
    '№219',
    'monday',
    2,
    '10:30:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Абильмажинов%' AND role = 'instructor' LIMIT 1),
    '№102',
    'wednesday',
    2,
    '10:30:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Қасымова%' AND role = 'instructor' LIMIT 1),
    '№102',
    'thursday',
    4,
    '13:50:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Шадаев%' AND role = 'instructor' LIMIT 1),
    '№212',
    'monday',
    1,
    '09:00:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Сатубалдина%' AND role = 'instructor' LIMIT 1),
    '№212',
    'monday',
    2,
    '10:30:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Валиев%' AND role = 'instructor' LIMIT 1),
    '№215',
    'monday',
    4,
    '13:50:00',
...
VALUES (
    (SELECT id FROM `groups` WHERE name = 'SЭЛ-240' LIMIT 1),
    (SELECT id FROM subjects WHERE name LIKE '%КМ-4 Тестілеу%' OR name LIKE '%КМ-4 Тестілеу%' LIMIT 1),
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Есимханов%' AND role = 'instructor' LIMIT 1),
    '№212',
    'friday',
    1,
    '09:00:00',
...
VALUES (
    ...
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Байболатов%' AND role = 'instructor' LIMIT 1),
    '№213',
    'monday',
    1,
    '09:00:00',
...
VALUES (
    (SELECT id FROM `groups` WHERE name = 'ТС-230' LIMIT 1),
    (SELECT id FROM subjects WHERE name LIKE '%ЖММ-1%' OR name LIKE '%ЖММ-1%' LIMIT 1),
    (SELECT id FROM users WHERE CONCAT(last_name, ' ', SUBSTRING(first_name, 1, 1), '.') LIKE '%Не%' AND role = 'instructor' LIMIT 1),
    'Не указано',
    'monday',
    4,
    '13:50:00',
